...
if nargin==0;   %If no graphics handle is specified
    h=get(gca,'title');
    set(h,'FontSize',22)    %Set font size of figure title
    
    h=get(gca,'xlabel');
    set(h,'FontSize',22)    %Set font size of x label
    
    h=get(gca,'ylabel');
    set(h,'FontSize',22)    %Set font size of y label
    
    set(gca,'FontSize',18)  %Set font size of all other text
    ...
    set(varargin{:},'FontSize',18)  % Set font size of all other text
