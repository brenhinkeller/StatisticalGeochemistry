...
for i=1:length(melts.minerals)
    ...
    if isempty(strfind(melts.minerals{i},'liquid')) && isempty(strfind(melts.minerals{i},'water')) && isempty(strfind(melts.minerals{i},'rhmoxide')) && isempty(strfind(melts.minerals{i},'feldspar'))
